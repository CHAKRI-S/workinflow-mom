  ...
  return (
    <CustomerForm
      ...
      defaultValues={{
        ...
        billingSubdistrict: customer.billingSubdistrict || undefined,
        billingDistrict: customer.billingDistrict || undefined,
        billingProvince: customer.billingProvince || undefined,
